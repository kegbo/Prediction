...
#Made as a subclass of the Recurrent Layer
class PredNet(Recurrent):
    ...
    def __init__(self, stack_sizes, R_stack_sizes,
        ...
        #Confirm all inputs parameters needed are apropriate for the network
        ...
        #Prednet is a subclass of the recurrent super class
